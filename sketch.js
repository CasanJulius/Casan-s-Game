...
var marioAnimation, obstacleAnimation, wallAnimation, groundAnimation,lowerwallAnimation;
var flag;
var LOSE=0;
var PLAY=1;
var WIN=2;
...
function preload()
{
  ...
  lowerwallAnimation=loadAnimation("images/Lowerwall.png");
...
function setup() {
  ...
  for (var i=0;i<26;i++)
     ...
     frameRate(30);
      ...
      if(i%2===0)
      {
      lowerwall=new Lowerwall(countDistanceX-250);
      platformGroup.add(lowerwall.spt);
      }
